...
export const RecentNewsList: React.FC<RecentNewsListProps> = ({ posts, postsToShow }) => {
  return (
    <Card className="h-full border-0 shadow-md py-4">
      <div
        className="sticky top-0 flex items-center justify-between gap-2 border-b border-gray-100 bg-white px-2 sm:px-3 py-0 z-10"
        style={{ borderColor: '#b01c14' }}
      >
        <div className="flex items-center gap-1 sm:gap-2">
          <Newspaper className="h-4 w-4 sm:h-5 sm:w-5" style={{ color: '#b01c14' }} />
          <h2 className="font-sans text-base sm:text-xl font-bold text-gray-900">Wararkii Ugu Dambeeyay</h2>
        </div>
