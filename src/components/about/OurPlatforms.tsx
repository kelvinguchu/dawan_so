...
export const OurPlatforms: React.FC = () => {
  const platforms = [
    ...
    },
    {
      name: 'Dawan TV',
      description:
        'Warar iyo nuxur ku qoran Ingiriisi, diiradda saaraya arrimaha Soomaaliya iyo qurbojoogta.',
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {platforms.map((platform, index) => (
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4 group-hover:text-[#b01c14] transition-colors duration-300">
                  {platform.name}
                </h3>
          ...
          <div className="text-center mt-12 sm:mt-16">
            <div className="bg-[#b01c14] rounded-lg sm:rounded-xl p-6 sm:p-8 text-white">
              <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">
                Isku Xiridda Bulshooyinka Afaf Kala Duwan
              </h3>
              <p className="text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
                Isku xirka dhaqamada iyo kobcinta is-fahamka gudaha Soomaaliya.
              </p>
            </div>
          </div>
        </div>
